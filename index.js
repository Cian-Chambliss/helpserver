...
module.exports = function(config) {
    ...
    var _lookupLink = function(indexLinks, symName) {
        if (indexLinks) {
    ...
    function HelpServerUtil(config) {
        ...
        if (!config.hasOwnProperty('escapes')) {
            config.escapes = [
                { from: ".html", to: "" }, { from: ".md", to: "" }, { from: ".xml", to: "" }, { from: "__STAR__", to: "*" }, { from: "__QUESTION__", to: "?" }, { from: "__SLASH__", to: "/" }, { from: "__BACKSLASH__", to: "\\" }, { from: "__NAMESPACE__", to: "::" }, { from: "__COLON__", to: ":" }, { from: "__ELLIPSES__", to: "..." }, { from: "__HASH__", to: "#" }, { from: "__GT__", to: ">" }, { from: "__LT__", to: "<" }, { from: "__PIPE__", to: "|" }
            ];
        }
    ...
    var pagesManifestArray = ["CACHE MANIFEST", "", "#Version __helpversionnumber__", "NETWORK:", "*", "CACHE:", "/assets/helpserver-toc.css", "/assets/helpserver-polyfills.js", "/assets/theme.css", "/assets/helpserver-page.css", "/assets/helpserver-page.js", "/assets/helpserver-main.css", "/toc_loader/__filter__" + (config.structurefile || "tree.json").replace(".json", ".js")];
    ...
    HelpServerUtil.prototype.lookupLink = function(symName) {
        return _lookupLink(indexLinks, symName);
    }
    var treeData = {};
    var parentIndexData = {};
    ...
    var expressHandler = {
        ...
        "index": function(hlp, path, req, res) {
            ...
            var loadPage = function() {
                var href = _lookupLink(indexLinks, name);
                if (href) {
